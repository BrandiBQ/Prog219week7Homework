...
console.log("function quit() is called.");
setCurrent_index(state.current_fullName); //get the index of the user
var userMongoID = userArray[state.current_index]._id; //get the mongo ID
var newBalance = state.current_balance;
...
$.ajax({
    type: 'PUT',
    url: '/users/modifyuser/' + userMongoID + '*' + newBalance  // passsing 2 arguements as one
    }).done(function( response ) {
  })
